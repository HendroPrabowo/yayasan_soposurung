...
/**
 * SwAplMknPgiSearch represents the model behind the search form of `app\models\SwAplMknPgi`.
 */
class SwAplMknPgiSearch extends SwAplMknPgi
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'jurnal_laporan_id' => $this->jurnal_laporan_piket_id,
        ]);
