...
/**
 * AplMknMalamSearch represents the model behind the search form of `app\models\AplMknMalam`.
 */
class AplMknMalamSearch extends AplMknMalam
{
    /**
     * {@inheritdoc}
     */
