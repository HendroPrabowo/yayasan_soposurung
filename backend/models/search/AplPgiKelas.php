...
use app\models\AplPgiKelas as AplPgiKelasModel;

/**
 * AplPgiKelas represents the model behind the search form of `app\models\AplPgiKelas`.
 */
class AplPgiKelas extends AplPgiKelasModel
{
    /**
     * {@inheritdoc}
     */
