...
<div class="siswa-apel-pagi-index">
    ...
    if(count($apel_pagi_kelas) != 0){
        echo 'Apel Pagi Kelas Sudah Dibuat. Silahkan hubungi Admin Untuk Mengubah';
    }else{
        echo Html::a('Isi Apel Pagi Kelas', ['apl-pgi-kelas/create', 'id' => $jurnal_laporan_piket->id], ['class' => 'btn btn-success']);
    }
    ?>
