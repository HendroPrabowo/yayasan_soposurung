...
<div class="siswa-apel-pagi-index">
    ...
    if(count($apel_pagi_kelas) != 0){
        echo 'Apel Makan Siang Sudah Dibuat. Silahkan hubungi Admin Untuk Mengubah';
    }else{
        if(!Yii::$app->user->can('supervisor')){
            echo Html::a('Isi Apel Makan Siang', ['apl-mkn-siang/create', 'id' => $jurnal_laporan_piket->id], ['class' => 'btn btn-success']);
        }
    }
    ?>
